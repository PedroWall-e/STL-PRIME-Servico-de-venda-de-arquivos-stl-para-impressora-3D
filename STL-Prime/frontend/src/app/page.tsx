                ...
                <div className="container mx-auto px-4 md:px-8 relative z-10 pt-20 pb-40 md:pt-32 md:pb-48">
                    <div className="max-w-3xl">
                        ...
                        <div className="flex flex-wrap items-center gap-4">
                            <Link href="/models" className="px-8 py-4 rounded-full font-black text-white text-lg transition-transform hover:scale-105 hover:shadow-[0_0_30px_rgba(51,71,255,0.3)] shadow-xl" style={{ backgroundColor: theme.blue }}>
                                Explorar Catálogo
                            </Link>
            ...
            <section className="relative z-20 -mt-20 container mx-auto px-4 md:px-8 mb-16">
                <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-xl shadow-gray-200/50 border border-white p-2 md:p-4 flex gap-2 md:gap-4 overflow-x-auto scrollbar-hide snap-x">
                    {CATEGORIES.map((cat, i) => (
                        <Link key={i} href={`/models?category=${encodeURIComponent(cat.name)}`} className="shrink-0 snap-start flex items-center gap-3 px-5 py-3 rounded-xl hover:bg-[#F0F3FF] text-gray-700 hover:text-[#3347FF] transition-all font-bold whitespace-nowrap group">
                    ...
                    <Link href="/models" className="shrink-0 snap-start flex items-center gap-2 px-6 py-3 rounded-xl text-gray-500 hover:text-gray-800 font-bold ml-auto">
                ...
                <div className="container mx-auto px-4 md:px-8">
                    ...
                    <div className="pt-8 border-t border-gray-200 flex flex-col md:flex-row items-center justify-between gap-4 text-xs font-medium text-gray-500">
                        ...
                        <div className="flex gap-6">
                            <Link href="/terms" className="text-gray-400 hover:text-[#3347FF] transition-colors">Termos de Serviço</Link>
                            <Link href="/privacy" className="text-gray-400 hover:text-[#3347FF] transition-colors">Política de Privacidade</Link>
